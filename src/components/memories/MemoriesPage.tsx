        ...
        >
          <div className="relative">
            ...
            <motion.button
              ...
              className="absolute right-3 bottom-3 p-3 rounded-xl bg-linear-to-r/srgb from-purple-500 to-pink-500 text-white disabled:opacity-50 transition-all"
            >
              {isAdding ? (
          ...
          {isLoading ? (
            ...
            memories.map((memory, index) => (
              <motion.div
                ...
                className={`relative p-5 rounded-2xl bg-linear-to-r/srgb ${getMemoryTypeColor(memory.memory_type)} border backdrop-blur-xs group`}
              >
