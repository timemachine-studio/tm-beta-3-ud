      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-6">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-2xl bg-linear-to-br/srgb from-blue-500/20 to-purple-500/20 border border-blue-500/20">
        ...
        <div className="space-y-3">
          {filteredFaqs.map((faq, index) => (
            ...
            >
              ...
              >
                <div className="p-2.5 rounded-xl bg-linear-to-br/srgb from-purple-500/20 to-blue-500/20 text-purple-400">
                  {faq.icon}
                </div>
        ...
        <motion.div
          ...
          className="mt-12 p-6 rounded-3xl bg-linear-to-br/srgb from-purple-500/10 to-blue-500/10 border border-white/10 text-center"
        >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-linear-to-r/srgb from-purple-500 to-blue-500 text-white font-medium"
          >
