...
export const seasonThemes: Record<string, Theme> = {
  ...
  brown: {
    name: 'Cocoa Cream',
    background: 'bg-gradient-to-br from-brown-100 to-brown-200',
    text: 'text-black',
    ...
    button: {
      primary: 'bg-brown-600 hover:bg-brown-700 text-white rounded-lg shadow-sm',
      secondary: 'bg-white/80 hover:bg-white/90 backdrop-blur-md text-black rounded-lg'
    },
    modal: {
      background: 'bg-white/80 backdrop-blur-lg shadow-lg',
    ...
    dropdown: {
      background: 'bg-white/80 backdrop-blur-md shadow-sm',
      hover: 'hover:bg-brown-100/50'
    },
    card: {
      background: 'bg-white/70 backdrop-blur-md shadow-sm',
      border: 'border-brown-200/30'
    },
    glow: {
      primary: 'shadow-[0_4px_12px_rgba(132,91,47,0.2)]',
      secondary: 'shadow-[0_4px_12px_rgba(0,0,0,0.05)]'
    }
  },
  brownDark: {
    name: 'Cocoa Night',
    background: 'bg-gradient-to-t from-brown-950 to-black to-50%',
    text: 'text-gray-200',
    border: 'border-gray-800/50',
    input: {
      background: 'bg-gray-900/70 backdrop-blur-3xl',
    ...
    button: {
      primary: 'bg-gradient-to-r from-brown-900 to-brown-800 hover:from-brown-800 hover:to-brown-700 text-white rounded-lg shadow-sm',
      secondary: 'bg-gray-900/80 hover:bg-gray-800/80 backdrop-blur-3xl text-gray-200 rounded-lg'
    },
    modal: {
      background: 'bg-gray-900/75 backdrop-blur-3xl shadow-lg',
    ...
    glow: {
      primary: 'shadow-[0_4px_16px_rgba(132,91,47,0.15)]',
      secondary: 'shadow-[0_4px_16px_rgba(0,0,0,0.1)]'
    }
  },
  monochrome: {
