...
export default defineConfig({
  ...
  // Keep Trigger.dev aligned with the Node 24 LTS runtime used by the Vercel
  // application. Node 24 includes the WebSocket implementation required by
  // the Supabase RealtimeClient imported by the task bundle.
  runtime: "node-24",
